...
const Dashboard: React.FC = () => {
    ...
    const citizenid = !isLoading ? data.citizenid : 'Loading...';
    const alerts = !isLoading ? data.alerts : 0;
    const citizens = !isLoading ? data.citizens : 0;
    const invoices = !isLoading ? data.invoices : 0;
        ...
        <Page header={{ 
            ...
            <div className='dashboard-container'>
                <div className='dashboard-header'>
                    ...
                    <Box icon='fa-solid fa-money-bills' title={t('dashboard.invoices')} value={invoices} />
                </div>
                <div className='dashboard-footer'>
                    <Chat citizenid={citizenid} />
                    <SimpleList
