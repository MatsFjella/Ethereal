...
local function SetLocationBlip()
  ...
  AddTextComponentString('Resirkulering')
...
local function DrawPackageLocationBlip()
  ...
  DrawMarker(2, packageCoords.x, packageCoords.y, packageCoords.z + 3, 0, 0, 0, 180.0, 0, 0, 0.5, 0.5, 0.5, 38, 199, 165, 100, false, false, 2, true, nil, nil, false)
end
