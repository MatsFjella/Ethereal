    ...
    if creationLaser then
        CreateThread(function()
            while creationLaser do
                local hit, coords = DrawLaser('PRESS ~g~E~w~ FOR Å PLASSERE SCENE\nPRESS ~g~G~w~ FOR Å ENDRE SCENE', {r = 2, g = 241, b = 181, a = 200})
    ...
    if deletionLaser then
        CreateThread(function()
            while deletionLaser do
                local hit, coords = DrawLaser('PRESS ~r~E~w~ FOR Å SLETTE SCENE\nPRESS ~r~G~w~ FOR Å AVBRYTE', {r = 255, g = 0, b = 0, a = 200})
