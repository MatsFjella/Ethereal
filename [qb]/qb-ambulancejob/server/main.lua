...
RegisterNetEvent('hospital:server:SendToBedPlayer', function(playerId,bedId, isRevive)
    TriggerClientEvent('hospital:client:SendToBed', playerId, bedId, Config.Locations["beds"][bedId], isRevive)
    TriggerClientEvent('hospital:client:SetBed', playerId, bedId, true)
end)
