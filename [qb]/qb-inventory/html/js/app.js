        ...
        if (itemData.info.ammo == undefined) {
            ...
            if (itemData.info.type == "casing") {
                ...
                $(".item-info-description").html(
                    ...
                    itemData.info.ID +
                    "</span></p><p><strong>Vekt: </strong><span>" +
                    itemData.info.weight +
                    "</span></p><p><strong>Plasser: </strong><span>" +
                    itemData.info.slots +
                    "</span></p>"
                );
                ...
                $(".item-info-description").html(
                    ...
                    itemData.info.label +
                    "</span></p><p><strong>Fingeravtrykk: </strong><span>" +
                    itemData.info.fingerprint +
                    "</span></p><p><strong>Hendelse: </strong><span>" +
                    itemData.info.street +
                    "</span></p><br /><p>" +
                    itemData.description +
                    "</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
                );
            ...
            $(".item-info-title").html('<p>' + itemData.label + '</p>')
            $(".item-info-description").html('<p>Art: ' + itemData.info.species + '</p>Vekt: ' + itemData.info.lbs + ' kg</p>Type: ' + itemData.info.type);
            ...
            $(".item-info-description").html('<p><strong>Box Eier: </strong><span>' + itemData.info.boxOwner + '</span></p> Ice Box to store all of your fish');
        }
        else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
...
(() => {
    ...
    Inventory.UseItem = function(data) {
        ...
        $("#itembox-action").html("<p>Brukte</p>");
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "Brukte " + data.itemAmount;
        if (data.type == "add") {
