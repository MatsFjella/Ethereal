...
Config.GuardSpawn = {
    vector4(-630.37, -229.1, 38.06, 277.05),
    vector4(-618.99, -237.52, 38.06, 55.46),
    vector4(-627.42, -225.99, 38.06, 203.11),
    vector4(-616.54, -229.27, 38.06, 125.38),
    vector4(-618.9, -226.19, 38.06, 135.57),
    vector4(-621.24, -231.45, 38.06, 127.26)
}
...
Config.GuardPerks = {
    accuracy = 65, --accuracy percentage
    canUseCover = true,
