...
client_scripts {
	'client/main.lua',
	'gabz_entitysets_mods_1.lua', -- We use this for maintenance 
	--'client/optional.lua'
}

files {
	-- Default (included)
	'gabz_timecycle_mods_1.xml', -- We use this for maintenance 
	'stream/appartment/appartment.ytyp',
	'stream/startingapt/gabz_pinkcage.ytyp',
	'stream/defaultshells/shellprops.ytyp',
	'stream/startingapt/shellpropsv11.ytyp',
    'stream/WarehouseShells/shellpropsv5', --- https://k4mb1.tebex.io/package/4673185
...
data_file 'DLC_ITYP_REQUEST' 'stream/startingapt/gabz_pinkcage.ytyp'
