...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    $(".manage-profile-editing-title").html(`Du redigerer nå ${result["firstname"]} ${result["lastname"]}`);
    ...
    let licencesHTML = '<div style="color: #fff; text-align:center;">Ingen lisens</div>';
    let tagsHTML = '<div style="color: #fff; text-align:center;">Ingen tagger</div>';
    let convHTML = '<div style="color: #fff; text-align:center;">Rent rulleblad</div>';
    ...
    let propertyHTML = '<div style="color: #fff; text-align:center;">Ingen eiendom</div>';
  ...
  $(".manage-profile-save").click(function () {
    if (canSaveProfile == true) {
      ...
      setTimeout(() => {
        $(".manage-profile-save").empty();
        $(".manage-profile-save").html("Lagre");
        canSaveProfile = true;
      }, 750);
      ...
      setTimeout(() => {
        ...
        $(".tags-holder")
          ...
          .each(function () {
          if ($(this).text() != "" && $(this).text() != "Ingen tagger") {
            tags.push($(this).text());
          }
        });
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      ...
      <div style="color: white;">
          ...
          <p><em>[Fyll inn info her]</em></p>
          <p>&nbsp;</p>
          <p><strong>🧍 Gissel:</strong> [Navn her]</p>
          <p>&nbsp;</p>
          <p><strong>🗄️ Bevis lokasjon:</strong> Stash # | Skuffe #</p>
          <p>&nbsp;</p>
          <p><strong>🔪 Våpen / bevis konfiskert:</strong></p>
          <p><em>· [Liste her]</em></p>
          <p>&nbsp;</p>
          <p>-----</p>
          <p><strong style="background-color: var(--color-1);">💸 Bot:</strong></p>
          <p>&nbsp;</p>
          <p><strong>⌚ Soning:</strong></p>
          <p>-----</p>
      </div>
  `;
    ...
    $(".manage-incidents-reports-content").trumbowyg('html', template);
      ...
      $(".manage-incidents-title-holder").prepend(
        `
            <div class="manage-incidents-title">Administrer hendelse</div>
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        ...
        <div style="color: white;">
            ...
            <p><strong>Rapport ID: [ Report ID ]</strong></p>
            <p><em><br></em></p>
            <p><strong>🧍Tid: [ Dato og tid ]</strong>&nbsp;</p>
            <p><strong>Surgery: [Ja/Nei]</strong></p>
            <p><strong>Skader/plager:</strong></p>
            <p><em>· [Skriv inn liste over skader her]</em><br></p>
            <p>&nbsp;</p>
            <p>-----</p>
            <p><strong style="background-color: var(--color-1);">Tilstede:</strong><br></p>
            <p><em>· [ List opp andre ansatte her ]</em></p>
            <p><strong style="background-color: var(--color-1);">🧑‍🤝‍🧑 Ytterligere nødkontakter:</strong><br></p>
            <p><em>· [ Navn og nummer ]</em></p>
            <p><strong style="background-color: var(--color-1);">Notater:</strong><br></p>
            <p><em>· [Ytterligere merknader her]</em></p>
            <p>-----</p>
        </div>
    `;
      }
      $(".manage-bolos-editing-title").html(
        "Du lager nå en ny etterlysning"
      );
          ...
          `
            <div class="associated-incidents-user-container" data-id="${$(this).data("cid")}">
                ...
                <div class="associated-incidents-user-tags-holder">
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Etterlysning</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Skyldig</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Prossesert</div>
                    <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Assosiert</div>
                </div>
                <div class="modify-charges-label"><span class="fas fa-solid fa-info"></span> Høyreklikk nedenfor for å legge til og/eller endre kostnader.</div>
                <div class="associated-incidents-user-holder" data-name="${$(this).data("cid")}"></div>
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Anbefalt bot</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Anbefalt setning</div>
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Bot</div>
                <div class="associated-incidents-fine-input" data-id="${$(this).data("cid")}"><img src="img/h7S5f9J.webp"> <input placeholder="Skriv inn fint her..." value="0" class="fine-amount" data-id="${$(this).data("cid")}" type="number"></div>
                <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Straff</div>
                <div class="associated-incidents-sentence-input" data-id="${$(this).data("cid")}"><img src="img/9Xn6xXK.webp"> <input placeholder="Skriv inn måneder her..." value="0" class="sentence-amount" data-id="${$(this).data("cid")}" type="number"></div>
                <div class="associated-incidents-controls" data-id="${$(this).data("cid")}">
                   
                    <div id="fine-button" class="control-button" data-id="${$(this).data("cid")}"><span class="fa-solid fa-file-invoice-dollar" style="margin-top: 3.5px;"></span> Bot</div>
                    ${canSendToCommunityService ? `<div id="community-service-button" class="control-button" data-id="${$(this).data("cid")}"> <span class="fa-solid fa-person-digging" style="margin-top: 3.5px;"></span>Samfunnstjeneste</div>` : ''}
                </div>
            </div>
          `
        );
  ...
  $(".manage-reports-title-holder").on(
    ...
    function () {
      ...
      if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
        template = `
    <div style="color: white;">
        <p><strong>Innlevert til ICU?: [Yes/No]</strong></p>
        <p><strong>Hendelse rapport:</strong></p>
        <p><em>· [ Kort oppsummering av hva som skjedde og hvem som gjorde hva mens du var på stedet. Legg merke til alt som skilte seg ut om scenen, samt hva som ble gjort for å behandle pasienten ]</em></p>
        <p><strong>Liste over skader:</strong></p>
        <p><em>· [ Oppgi hvilken eller hvilke skader som har oppstått ]</em></p>
        <p><strong>Kirurgisk rapport:</strong></p>
        <p><em>· [ Full rapport om hva som ble gjort under operasjonen, liste opp eventuelle komplikasjoner eller noe som ble funnet under operasjonen. Legg merke til hvem som deltok og hva de gjorde under operasjonen. På slutten av rapporten sørg for å notere tilstanden til pasienten etter ]</em></p>
        <p>-----</p>
        <p><strong>Deltar:</strong></p>
        <p><em>· [ List opp eventuelle deltakere her ]</em></p>
        <p><strong>Påførte medisiner:</strong></p>
        <p><em>· [ List opp eventuelle deltakere her ]</em></p>
        <p>-----</p>
        <br>
        <p><strong>Notat:</strong></p>
        <p><em>[ Ytterligere merknader her ]</em></p>
    </div>
`;}
      $(".manage-reports-editing-title").html(
        "Du oppretter for øyeblikket en ny rapport"
      );
            ...
            `
                            <div class="profile-item" data-id="0">
                                ...
                                <div style="display: flex; flex-direction: column;">
                                    <div class="profile-item-title">Ingen kjøretøy som matcher søket</div>
                                    </div>
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="dmv-item-title">${value.model}</div>
                                    <div class="dmv-tags">
                                        ...
                                        <div class="dmv-tag ${impound}">Inntauing</div>
                                        <div class="dmv-tag ${bolo}">Etterlysning</div>
                                        <div class="dmv-tag ${stolen}">Stjelt</div>
                                        <div class="dmv-tag ${codefive}">Code 5</div>
                                    </div>
                                </div>
                                <div class="dmv-bottom-info">
                                    <div class="dmv-id">Skilt: ${value.plate} · Eier: ${value.owner}</div>
                                </div>
                            </div>
                        </div>
                    `;
          ...
          $(".weapons-items").html(
            `
                            <div class="profile-item" data-id="0">
                                ...
                                <div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 5px; width: 100%; padding: 5px;">
                                <div style="display: flex; flex-direction: column;">
                                    <div class="profile-item-title">Ingen våpen som matcher søket</div>
                                    </div>
                                    <div class="profile-bottom-info">
                                    </div>
                                </div>
                            ...
                            <div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 5px; width: 100%; padding: 5px;">
                              <div style="display: flex; flex-direction: column;">
                                ...
                                <div class="weapons-bottom-info">
                                  <div class="weapons-id">Serienummer: ${value.serial} · Eier: ${value.owner} · ID: ${value.id}</div>
                                </div>
                            </div>
                        </div>
                    `;
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined)  {
        ...
        $(".bolo-nav-item").html("Etterlysning");
        $(".bolos-search-title").html("Etterlysning");
        $("#bolos-search-input").attr("placeholder", "Søk i etterlysninger...");
        $(".manage-bolos-title").html("Administrer etterlysning");
        $(".manage-bolos-editing-title").html(
          "Du lager nå en ny etterlysning"
        );
        $(".boloplate-title").html("Skilt");
        $(".boloowner-title").html("Eier");
        $(".boloindividual-title").html("Person");
        $("#boloplate").attr("placeholder", "Skriv skilt her...");
        $("#bolodetail").attr(
          "placeholder",
          "Etterlysningsdetaljer her..."
        );
        $("#boloowner").attr(
          "placeholder",
          "Plasser kjøretøyeieren her..."
        );
        $("#boloindividual").attr(
          "placeholder",
          "Plasser invidivual her..."
        );
        ...
        $(".cams-nav-item").show();
        $(".map-nav-item").show();
        $(".dispatch-title-ofsomesort").html("Sentral");
        ...
        $("#bolos-search-input").attr(
          "placeholder",
          "Søk etter innsjekkinger..."
        );
        $(".manage-bolos-title").html("Administrer ICU innsjekk");
        $(".manage-bolos-editing-title").html(
          "Du oppretter en ny ICU-innsjekking"
        );
        $(".boloplate-title").html("Estimert gjenoppretting");
        $(".boloowner-title").html("Nødtelefon");
        $(".boloindividual-title").html("Pasient");
        $("#boloplate").attr(
          "placeholder",
          "Angi restitusjonstid her..."
        );
        $("#bolodetail").attr(
          "placeholder",
          "Skriv inn ICU-innsjekkingsdetaljer her..."
        );
        $("#boloowner").attr(
          "placeholder",
          "Skriv inn nødkontakt her..."
        );
        $("#boloindividual").attr(
          "placeholder",
          "Skriv inn pasientnavn og CID her..."
        );
    ...
    if (eventData.type == "show") {
     ...
     /*  let fireCount = 0; */
      ...
      activeUnits.forEach((unit) => {
        ...
        let activeInfoJob = `<div class="unit-job active-info-job-unk">UKJENT</div>`;
