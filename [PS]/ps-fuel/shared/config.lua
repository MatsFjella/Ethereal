...
Config.VehicleBlowUp = false -- when set to true vehicle has a chance to blow up if engine is left running
Config.BlowUpChance = 5 -- percentage for chance of engine explosion
Config.RefillCost = 1000 -- default price
Config.CostMultiplier = 3.0 -- tax basically
Config.canCost = 5000 -- buy jerry can price
Config.refuelCost = 3000 -- refueling jerry can price
Config.GlobalTax = 15.0

Config.fuelPrice = 4.0 -- fuel price in litres I guess
