...
QBCore.Functions.CreateUseableItem("fishingloot", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		TriggerClientEvent('QBCore:Notify', src, "Åpner boksen..", "primary")
		SetTimeout(1000, function()
			...
			-- TriggerClientEvent('QBCore:Notify', src, " "..Config.smallLootboxCash, "success")
		end)
    end
end)
...
QBCore.Functions.CreateUseableItem("fishtacklebox", function(source, item)
	...
	if Player.Functions.GetItemBySlot(item.slot) ~= nil then
		...
		TriggerClientEvent('QBCore:Notify', src, "Åpner boksen..", "success")
...
RegisterNetEvent('fishing:server:catch', function() 
    ...
    if itemFound then
        for i = 1, itemCount, 1 do
            if luck == 100 then
				local weight = math.random(3000,4000)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en hval på "..weight.."kg!", "primary")
			...
			elseif luck >= 90 and luck <= 95 then
				local weight = math.random(130,170)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en delfin på "..weight.."kg!", "primary")
			elseif luck >= 85 and luck <= 90 then
				local weight = math.random(400,600)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en hammerhai på "..weight.."kg!", "primary")
			elseif luck >= 80 and luck <= 85 then
				local weight = math.random(380,630)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en tigerhai på "..weight.."kg!", "primary")
			elseif luck >= 70 and luck <= 80 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en rokke på "..weight.."kg!", "success")
			elseif luck >= 60 and luck <= 70 then
				local weight = math.random(1,7)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en flyndre på " .. weight .. "kg!", "success")
			elseif luck >= 55 and luck <= 60 then
				...
				-- TriggerClientEvent('QBCore:Notify', src, " ", "primary")
			elseif luck >= 45 and luck <= 55 then
				local weight = math.random(5,10)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en bass på " .. weight .. "kg!", "success")
			elseif luck >= 40 and luck <= 45 then
				...
				-- TriggerClientEvent('QBCore:Notify', src, " ", "success")
			elseif luck >= 23 and luck <= 40 then
				local weight = math.random(30,50)
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en torsk på " .. weight .. "kg!", "success")
			elseif luck >= 18 and luck <= 23 then
				...
				-- TriggerClientEvent('QBCore:Notify', src, " ", "primary")
			elseif luck >= 0 and luck <= 18 then
				...
				TriggerClientEvent('QBCore:Notify', src, "Du fikk en makrell på " .. weight .. "kg!", "success")
            end
            Citizen.Wait(500)
        end
    end
...
RegisterNetEvent('fishing:server:SellillegalFish', function(args)
	...
	if args == 1 then 
		...
		if dolphin ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Delfin solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen delfiner å selge", 'error')
		end
	elseif args == 2 then 
		...
		if sharktiger ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Tigerhai solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen tigerhai å selge", 'error')
		end
	elseif args == 3 then 
		...
		if sharkhammer ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Hammerhai solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen hammerhai å selge", 'error')
		end
	else
		...
		if killerwhale ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "Hval solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellillegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen hvaler å selge", "error")
		end
	end
end)
...
RegisterNetEvent('fishing:server:SellLegalFish', function(args) 
	...
	if args == 1 then 
		...
		if mackerel ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 Makrell solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har ingen makreller å selge", "error")
		end
	elseif args == 2 then
		...
		if codfish ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 Torsk Solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har ingen torsker å selge", "error")
		end
	elseif args == 3 then
		...
		if bass ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 Havabbor Solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
			TriggerClientEvent('QBCore:Notify', src, "Du har ingen Havabborer å selge", "error")
		end
	elseif args == 4 then
		...
		if flounder ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 Flyndre Solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har ingen flyndrer å selge", "error")
		end
	else
		...
		if stingray ~= nil then
			...
			TriggerClientEvent('QBCore:Notify', src, "1 Rokke Solgt for "..payment.."kr", "success")
			TriggerClientEvent("doj:client:SellLegalFish", source)
		else
		    TriggerClientEvent('QBCore:Notify', src, "Du har ingen rokker å selge", "error")
		end
	end
end)
...
QBCore.Functions.CreateCallback('fishing:server:checkMoney', function(source, cb)
    ...
    if bankBalance >= price then
		...
		TriggerClientEvent('QBCore:Notify', src, "Båt har blitt leid for $"..price, "success")
        cb(true)
    else
        TriggerClientEvent('QBCore:Notify', src, "Du har ikke nok penger..", "error")
        cb(false)
