...
Config.trucker_locations = {
	["trucker_1"] = {															-- ID
		['menu_location'] = {153.26, -3211.68, 5.91},	-- Coordinate to open the menu (vector3)
		['garage_location'] = {													-- Garage coordinates, where the trucks will spawn (vector4)
			{168.58, -3219.22, 5.84, 270.28},
			{168.67, -3224.17, 5.83, 269.76},
			{168.41, -3229.62, 5.84, 272.28},
			{168.50, -3234.81, 5.85, 271.32},
			{166.93, -3240.05, 5.87, 271.91},
			{165.37, -3190.89, 5.90, 268.95},
		},
		['trailer_location'] = {												-- Trailer coordinates, where the trailers will spawn (vector4)
			{169.18, -3019.43, 5.87, 271.79},
			{170.16, -3013.93, 5.87, 270.73},
			{171.40, -2996.88, 5.80, 288.36},
			{171.28, -2992.02, 5.86, 274.05},
			{171.15, -2986.83, 5.89, 272.51},
			{175.44, -2978.06, 5.92, 260.77},
			{177.49, -2969.72, 5.97, 260.11},
			{179.27, -2965.17, 5.99, 259.30},
		},
		['blips'] = {							-- Create the blips on map
			['id'] = 478,						-- Blip ID [Set this value 0 to dont have blip]
			['name'] = "Transport",		-- Blip Name
			['color'] = 4,						-- Blip Color
...
Config.jobs = {
	...
	['max_contratos_ativos'] = 120,				-- Maximum of contracts that can be active, this means that when generating a contact that exceeds this number, the oldest contract will be deleted
	...
	['available_loads'] = {
		...
		{ trailer = "armytanker", name = "Empty army trailer", def = {0,0,0}},
