		...
		if CurrentTest == 'drive' then
			...
			if IsPedInAnyVehicle(playerPed, false) then
				...
				if vehicleplate ~= vehplate then
					...
					-- 	if not exports['ps-hud']:checkseatbelt() and CurrentCheckPoint > 1 and not seatbelterr[CurrentCheckPoint] then
					-- 		seatbelterr[CurrentCheckPoint] = false
					-- 		DriveErrors = DriveErrors + 5
...
exports['ox_target']:addSphereZone({
	coords = vec3(221.32, -1393.48, 30.59),
	radius = 3,
	debug = drawZones,
	drawSprite = true,
	options = {
